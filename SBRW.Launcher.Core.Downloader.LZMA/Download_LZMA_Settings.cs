...
namespace SBRW.Launcher.Core.Downloader.LZMA
{
    ...
    public static class Download_LZMA_Settings
    {
        ...
        private static string Version 
        {
            get
            {
                if(!Version_Check)
                {
                    try
                    {
                        if (File.Exists("SBRW.Launcher.Core.Downloader.LZMA.dll"))
                        {
                            Version_Cache = FileVersionInfo.GetVersionInfo("SBRW.Launcher.Core.Downloader.LZMA.dll").FileVersion;
                        }
                    }
                    catch
                    {
        ...
        /// 
        /// </summary>
        internal static string Header = "SBRW.Launcher.Core.Downloader.LZMA.LZMA Version " + Version + " (+https://github.com/DavidCarbon-SBRW/SBRW.Launcher.Core.Downloader.LZMA)";
        /// <summary>
        /// 
        /// </summary>
        internal static string Header_LZMA = "SBRW.Launcher.Core.Downloader.LZMA Version " + Version + " (+https://github.com/DavidCarbon-SBRW/SBRW.Launcher.Core.Downloader.LZMA)";
        /// <summary>
